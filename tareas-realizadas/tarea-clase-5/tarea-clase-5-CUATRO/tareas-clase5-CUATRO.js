...
function calcularPromedio(arrayNumeros){
  ...
  for(let i = 0; i<arrayNumeros.length; i++){
    totalNumeros += arrayNumeros[i]; 
  }
  return (totalNumeros/arrayNumeros.length);
};

function calcularNumeroMayor(arrayNumeros){
...
function calcularNumeroMenor(arrayNumeros){
...
//Anda pero si hay dos números con misma moda te tira el primero nomás
...
$botonCalcular.onclick = function(){
  ...
  //Creo el array
  let $nodeValuesNumeros = document.querySelectorAll('li');
  let arrayNumeros = [];
  for(let i = 0; i<$nodeValuesNumeros.length; i++){
    arrayNumeros.push(Number($nodeValuesNumeros[i].textContent));
  };
  
  let $resultadoPromedio = document.querySelector('#resultado-promedio');
  let $resultadoMayorNumero = document.querySelector('#resultado-mayor');
  let $resultadoMenorNumero = document.querySelector('#resultado-menor');
  let $resultadoModa = document.querySelector('#resultado-moda');

  $resultadoPromedio.textContent = `El promedio es ${calcularPromedio(arrayNumeros)}`;
  $resultadoMayorNumero.textContent = `El mayor número es ${calcularNumeroMayor(arrayNumeros)}`;
  $resultadoMenorNumero.textContent = `El menor número es ${calcularNumeroMenor(arrayNumeros)}`;
  $resultadoModa.textContent = `La moda es ${calcularModa(arrayNumeros)}`;
