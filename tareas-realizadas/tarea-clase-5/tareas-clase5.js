...
let $botonCalculoSalario = document.querySelector('#boton-calculo'); //agregar un boton "limpiar"

$botonCalculoSalario.onclick = function(){
  let mesesAño = 12;
  let salarioAnualUsuario = document.querySelector('#salario-anual-usuario').value;
  let resultadoSalarioMensualUsuario = document.querySelector('#salario-mensual-usuario');
  resultadoSalarioMensualUsuario.value = salarioAnualUsuario / mesesAño; //hacer una function de esto y llamarla
  return false;
}
