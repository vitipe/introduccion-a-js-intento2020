...
$botonIngresar.onclick = function(){
  let primerNombreUsuario = document.querySelector('#primer-nombre-usuario').value;
  ...
  let $tituloBienvenida = document.querySelector('#titulo');
  $tituloBienvenida.textContent = "Hola, " + primerNombreUsuario + "!";

  let $nombreCompletoUsuario = document.querySelector('#nombre-completo-usuario');
  $nombreCompletoUsuario.value = primerNombreUsuario + ' ' + segundoNombreUsuario + ' ' + apellidoUsuario + ' ' + edadUsuario; //Aca habría un bug, que si un usuario no pone un 2do nombre queda un espacio al medio al pedo
